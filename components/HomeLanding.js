...
const steps = [
    ...
    { title: "ORVA Executes Task", desc: "Trained partners work through a managed process.", icon: Zap },
...
const reasons = [
    ...
    },
    {
        ...
        desc: "Trained partners, managed by ORVA.",
        icon: ShieldCheck,
    },
    {
...
const faqs = [
    ...
    },
    {
        ...
        a: "Yes. ORVA is built for Hyderabad and Indian small businesses.",
    },
    {
    ...
    return (
        <main className="gradient-page overflow-hidden">
            ...
            <section className="section-space relative mx-auto max-w-[1440px] px-6">
                ...
                <SectionHeader
                    eyebrow="Why ORVA"
                    title="Why Businesses Choose ORVA"
                ...
                <div className="premium-dark-panel hero-noise relative overflow-hidden p-8 text-center text-white shadow-2xl shadow-blue-950/30 md:p-14">
                    ...
                    <div className="relative">
                        ...
                        <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-300">
                            Choose a service and let ORVA handle the execution.
                        </p>
