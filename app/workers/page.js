    ...
    return (
        <main className="gradient-page">
            <section className="mx-auto grid max-w-[1440px] gap-10 px-6 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                <div>
                    <p className="eyebrow">For ORVA Partners</p>
                    ...
                    <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
                        Join ORVA as a remote partner, get trained, and work on simple digital tasks for clients across WhatsApp, Instagram, listings, websites, and ads.
                    </p>
            ...
            <section id="training" className="mx-auto max-w-[1440px] px-6 py-16">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mt-4 text-lg leading-8 text-slate-600">
                        ORVA keeps the process clear so you know what to do before, during, and after every task.
                    </p>
                </div>
                ...
                <div className="grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-start">
                    ...
                    <div className="premium-dark-panel relative overflow-hidden p-8 text-white">
                        ...
                        <p className="relative mt-4 text-lg leading-8 text-slate-300">
                            We focus on reliable ORVA partners who can learn, communicate clearly, and complete tasks carefully.
                        </p>
            ...
            <section className="mx-auto max-w-[1440px] px-6 py-16">
                <div className="premium-panel p-8 text-center md:p-12">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-lg leading-8 text-slate-600">
                        Submit your ORVA partner application and our team will review your details before connecting you with suitable work.
                    </p>
